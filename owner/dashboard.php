...
try {
  ...
  foreach ($shopIds as $sid) {
    if (is_subscribed((int)$sid)) {
      $ownerHasActiveSub = true;
      break;
    }
  }
  ...
  <main class="owner-main">
    ...
    <?php else: ?>
      ...
      <style>
        ...
        .btn-accent.btn-select:active {
          transform: translateY(0);
        }

        .btn-accent.btn-select:focus-visible {
      ...
      <div class="lim-pair">
        <div class="shop-box">
          <div class="shop-header-flex">
            ...
            if (!$isVerified && $hasPendingDocs) {
              $statusLabel = 'PENDING REVIEW';
              $statusTitle = 'Documents submitted - pending review';
            } elseif ($isVerified && !$ownerHasActiveSub) {
              $statusLabel = 'NO SUBSCRIPTION';
              $statusTitle = 'Account verified – subscription required';
            }
            ?>
          ...
          <p class="mini-note" style="margin-top:.4rem;">Customers cannot see your shop until verification is complete and you have an active subscription.</p>
          <div style="display:flex;gap:.6rem;flex-wrap:wrap;">
            <?php if (!$isVerified): ?>
