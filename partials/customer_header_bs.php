...
<nav class="navbar navbar-expand-lg navbar-dark py-3" style="background:rgba(16,22,30,.9);backdrop-filter:blur(10px);border-bottom:1px solid #22303d;">
    <div class="container-fluid" style="max-width:1320px;">
        <a class="navbar-brand d-flex align-items-center gap-2" href="dashboard.php">
            ...
            <span class="fw-bold">Barber<span style="background:linear-gradient(135deg,#f59e0b,#fbbf24);-webkit-background-clip:text;background-clip:text;color:transparent;">Sure</span><span class="ms-2 badge text-bg-dark border border-warning-subtle" style="font-size:.55rem;letter-spacing:.5px;">CUSTOMER</span></span>
        </a>
